...
humandate: "January 16-19, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "11:00 am - 3:00 pm Pacific"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Sarah Stevens", "Tim Dennis", "Erin Becker"] # boxed, comma-separated list of trainers' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["sarah.stevens@wisc.edu", "tdennis@library.ucla.edu", "ebecker@carpentries.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
